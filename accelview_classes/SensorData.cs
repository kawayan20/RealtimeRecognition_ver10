...
namespace accelview_classes
{
    ...
    public class SensorData
    {
        ...
        private const int maximumData = 15000;
        ...
        public void pushData(AccelData input)
        {
            ...
            {
                int t = this.allData[this.allData.Count - 1].Time - this.allData[this.allData.Count - 2].Time;
                if (t != 0)
                {
            ...
            if (this.allData.Count > maximumData)
            {
                ...
                //this.allData.RemoveAt(1);
                this.allData.RemoveRange(0, 10000);
